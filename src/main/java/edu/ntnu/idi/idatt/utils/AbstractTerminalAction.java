 ...
 * {@code scanner} - {@link Scanner}-object that is used to fetch
 user info ({@link AbstractTerminalAction#getInput() getInput()}).<br>
 * {@code scannerStatic} - {@link Scanner}-object that is used to fetch user
 info while being static
 ({@link AbstractTerminalAction#getInputStatic() getInputStatic()}).<br><br>
 *
...
public abstract class AbstractTerminalAction {
   ...
   * The idea behind this method is to correctly close the Scanner-objects,
   so that there would not be any data-leaks.
   */
