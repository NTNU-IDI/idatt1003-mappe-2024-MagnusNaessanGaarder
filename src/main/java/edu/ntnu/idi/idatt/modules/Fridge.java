 ...
 * {@code groceryList} - An {@link ArrayList} with content of
 type {@link Grocery}.<br><br>
 *
 * <strong>Methods:</strong><br>
 * {@link #getGroceryList} - Get-method, fetches groceryList of all available
 Grocerys stored in the fridge with incapsulation.<br>
 ...
 * {@link #toString()} - Method for dumping the contents of the object as a string.
 * For debugging or just simly displaying the whole Fridge.<br>
 */
public class Fridge {
  ...
  /**
   * <strong>Description:</strong><br>
   * A constructor instantizing the Fridge class and initializing datafields
   of the class.
   */
  public Fridge() {
    ...
    if (groceryList.contains(grocery)) {
      ...
      if (index != -1) {
        ...
        throw new IllegalArgumentException(
            "Argument not valid! Cannot remove " + grocery.getName() + " from Grocery list!");
      }
    } else {
